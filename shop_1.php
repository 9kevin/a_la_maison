    ...
    <div id="_browser_body">
        <div id="_main">
            ...
            <div id="_upper_main_shop1">
                ...
                <main id="_main_body">
                    <p id="_spa_p"> <span>Shop</span> <br> Whether you've come to buy or you have some amazing <br>
                        products to sell, this is the best platform for you.</p>
                    <ul id="_arrival_info">
                        <form>
            ...
            <div id="_lower_main">
                <img class="img_1" src="Stylesheets/images/Shop1.png" alt="image">
                <img class="img_2" src="Stylesheets/images/Shop2.png" alt="image">

                <h3 id="shop_h1"> Treat yourself to some amazing products that are available at best prices </h3>

                <p id="shop_p1"> Veggies es bonus vobis, proinde vos postulo essum magis kohlrabi welsh onion daikon amaranth tatsoi
                    tomatillo melon azuki bean garlic....</p>
                <p id="shop_p2"> Veggies es bonus vobis, proinde vos postulo essum magis kohlrabi welsh onion daikon amaranth tatsoi
                ...
                <a href="shop_2.php"> <button id="shop_btn_1" type="button"> I WANT TO BUY </button> </a>
                <a href="log_in.php"> <button id="shop_btn_2" type="button"> I WANT TO SELL </button> </a>
